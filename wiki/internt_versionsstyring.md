...
Vi benytter GitHub til versionsstyring. Dette er en guide til hvordan vi arbejder parallelt på kuben og implementerer vores ændringer via. GitHub. **Alle ændringer som laves på *CHRU_HRKube* skal ske gennem GitHub**. Dette gælder både i udvikling og produktion. Man må kun ændre direkte i *CHRU_HRKube* hvis der er akutte ændringer som ikke kan vente. Følgende figur illusterer arbejdsprocessen med GitHub. De forskellige skridt er beskrevet nedenfor.
